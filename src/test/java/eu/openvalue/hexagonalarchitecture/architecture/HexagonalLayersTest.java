...
class HexagonalLayersTest {
  ...
  @ArchTest
  static final ArchRule checkNoShortCutsAdapterIn = classes()
      .that()
  ...
  @ArchTest
  static final ArchRule checkNoShortCutsAdapterOut = classes()
      .that()
      .resideInAPackage("eu.openvalue.hexagonalarchitecture.adapter.out..")
      .should()
      .onlyBeAccessed()
      .byAnyPackage(
          "eu.openvalue.hexagonalarchitecture.adapter.out..",
          "eu.openvalue.hexagonalarchitecture.application.port.out.."
      );

  @ArchTest
  static final ArchRule checkPortsInOnlyCalledByAdapterIn = classes()
      .that()
      .resideInAPackage("eu.openvalue.hexagonalarchitecture.application.port.in..")
      .and()
  ...
  @ArchTest
  static final ArchRule checkPortsOutOnlyCalledByService = classes()
      .that()
      .resideInAPackage("eu.openvalue.hexagonalarchitecture.application.port.out..")
      .and()
